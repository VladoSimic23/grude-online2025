...
export const metadata: Metadata = {
  ...
  description: "Kategorija - Zanimljivosti",
  openGraph: {
    url: "https://www.grude-online.info/category/zanimljivosti",
    description: "Kategorija - Zanimljivosti",
    type: "article",
...
const Zanimljivosti = async () => {
  ...
  return (
    <div className="container" style={{ marginTop: "80px" }}>
      {deviceType === "mobile" && (
        <h1 className={`orangeBorder`}>Zanimljivosti</h1>
      )}
      {deviceType === "mobile" && <MobilePostListByCategory data={data} />}
      {deviceType === "mobile" && (
        <MobilePostListByCategoryClient category="Zanimljivosti" />
      )}
